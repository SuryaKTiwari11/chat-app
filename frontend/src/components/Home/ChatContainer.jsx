      ...
      >        {messages.map((message, index) => (
          ...
          >
            <div className="chat-image avatar">
              <div className="size-10 rounded-full border-2 border-indigo-500 shadow-md hover:shadow-indigo-500/30 transition-all duration-300">
                {message.senderId === authUser._id && authUser.profilePic ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-indigo-500 to-cyan-400 flex items-center justify-center text-white font-semibold text-xl">
                    {message.senderId === authUser._id
                      ? authUser.fullname[0]?.toUpperCase() || "U"
                      : selectedUser.fullname[0]?.toUpperCase() || "U"}
                  </div>
            ...
            <div className="chat-header mb-1">
              ...
              message.senderId === authUser._id 
                ? "bg-gradient-to-r from-indigo-500/90 to-cyan-500/90" 
                : "bg-[#334155]"
            } shadow-md`}>
              {message.image && (
                <img
                  src={message.image}
                  alt="Attachment"
                  className="sm:max-w-[200px] rounded-md mb-2 hover:opacity-95 transition-opacity duration-300 shadow-sm"
                />
              )}
